...
public class BoardPage {
    ...
    public static String pagingStr(int totalCount, int pageSize, int blockPage,
        ...
        */
        ...
        // 첫번째 블럭이 아닐때만 이전블록 바로가기 링크를 화면에 출력한다.
        if (pageTemp != 1) {
    ...
    public static String pagingImg(int totalCount, int pageSize, int blockPage,
        ...
        if (pageTemp != 1) {
            pagingImg += "<a href='" + reqUrl + "?pageNum=1'><img src='../images/paging1.gif' /></a>";            
            pagingImg += "&nbsp;";
            pagingImg += "<a href='" + reqUrl + "?pageNum=" + (pageTemp - 1)
        ...
        while (blockCount <= blockPage && pageTemp <= totalPages) {
            if (pageTemp == pageNum) {
                ...
                pagingImg += "&nbsp;<a href='" + reqUrl + "?pageNum=" + pageTemp
                             + "'>" + pageTemp + "</a>&nbsp;";
            }
            pageTemp++;
            blockCount++;
        ...
        if (pageTemp <= totalPages) {
            ...
            pagingImg += "&nbsp;";
            pagingImg += "<a href='" + reqUrl + "?pageNum=" + totalPages
